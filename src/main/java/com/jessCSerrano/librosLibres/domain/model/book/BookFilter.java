...
/**
 * Represents a book filter with parameters such as max price, author name, author last name publisher and literary genre for searching books.
 *
 ...
 */
public record BookFilter(BigDecimal maxPrice, String authorName, String authorLastName, String publisher,
