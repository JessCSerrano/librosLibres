...
public class BookController {
     ...
     * @param authorFirstName     filter books written by the specified author (first firstName)
     * @param authorLastName filter books written by the specified author  (last firstName)
